...
color_edit3   :: proc(label : string, col_: [3]f32, flags := Color_Edit_Flags(0)) -> bool                           {
    col := col_;
    return im_color_edit3(_make_label_string(label), &col[0], flags);
}
color_edit4   :: proc(label : string, col_ : [4]f32, flags := Color_Edit_Flags(0)) -> bool                           {
    col := col_;
    return im_color_edit4(_make_label_string(label), &col[0], flags);
}

color_picker  :: proc{color_picker3, color_picker4};
color_picker3 :: proc(label : string, col_ : [3]f32, flags := Color_Edit_Flags(0)) -> bool {
    col := col_;
    return im_color_picker3(_make_label_string(label), &col[0], flags);
}
color_picker4 :: proc(label : string, col_ : [4]f32, flags := Color_Edit_Flags(0)) -> bool {
    col := col_;
